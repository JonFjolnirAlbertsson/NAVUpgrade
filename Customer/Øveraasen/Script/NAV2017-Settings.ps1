...
$NAVInstallConfigFile = "C:\GitHub\NAVUpgrade\NAVSetup\FullInstallNAV2017.xml"
$NAVLicense = "$RootFolderPath\License\NAV2016.flf"
#$CUDownloadFile = 'C:\Temp\NAV\NAV2016\Temp\490370_NOR_i386_zip.exe'
$ZippedDVDfile  = "$RootFolderPath\NAV\NAV2017\Temp\490370_NOR_i386_zip.exe"
#Company data
$CompanyName = 'Elas'
...
$ModifiedObjectFile = 'NAV2016CU5Elas.txt'
...
#Original Version
$OriginalVersion = 'NAV2016_CU5_NO'
